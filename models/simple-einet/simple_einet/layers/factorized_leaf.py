...
class FactorizedLeaf(AbstractLayer):
    ...
    def forward(self, x: torch.Tensor, marginalized_scopes: List[int], scaling_factors: torch.Tensor = None):
        """
        ...
        x = self.base_leaf(x, marginalized_scopes, scaling_factors=scaling_factors)
